...
export interface LpFarmingVaultInterface extends utils.Interface {
  contractName: "LpFarmingVault";
  functions: {
...
export interface LpFarmingVault extends BaseContract {
  contractName: "LpFarmingVault";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LpFarmingVaultInterface;
