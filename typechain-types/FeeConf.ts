...
export interface FeeConfInterface extends utils.Interface {
  contractName: "FeeConf";
  functions: {
    "PercentBase()": FunctionFragment;
    "getConfig(bytes32)": FunctionFragment;
    "owner()": FunctionFragment;
    "renounceOwnership()": FunctionFragment;
    "setConfig(bytes32,address,uint16)": FunctionFragment;
  ...
  events: {
    ...
    "SetConfig(bytes32,address,uint16)": EventFragment;
  };
...
export type SetConfigEvent = TypedEvent<
  ...
  { key: string; receiver: string; rate: number }
>;

export type SetConfigEventFilter = TypedEventFilter<SetConfigEvent>;

export interface FeeConf extends BaseContract {
  contractName: "FeeConf";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: FeeConfInterface;
  ...
  filters: {
    ...
    "SetConfig(bytes32,address,uint16)"(
      key?: null,
      receiver?: null,
      rate?: null
    ): SetConfigEventFilter;
    SetConfig(key?: null, receiver?: null, rate?: null): SetConfigEventFilter;
  };
