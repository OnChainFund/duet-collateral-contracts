...
export interface DepositVaultBaseInterface extends utils.Interface {
  contractName: "DepositVaultBase";
  functions: {
...
export interface DepositVaultBase extends BaseContract {
  contractName: "DepositVaultBase";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: DepositVaultBaseInterface;
